...
from .payments import DALPayments
...
class DALPaymentEvents(
    ...
    ENSURE_JSON_SAFETY_FIELDS = {"payload"}
...
__all__ = [
    ...
    "DAOGiftcardsUpdate",
    "DAOGiftcardEventsCreate",
    "DAOGiftcardEventsUpdate",  # Updating is not allowed, as it's an append-only log trail
    ##########################################################
    # Utils
    ##########################################################
    "safe_commit",
